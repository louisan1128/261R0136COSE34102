...
def main():
    ...
    outputs = {
        ...
        "cache": root / config.get("llm_rewrite", {}).get("cache_path", "data/outputs/cache/llm_rewrite_cache.jsonl"),
        ...
        "final": root / data.get("final_comparison_path", "data/outputs/evaluation/final_policy_comparison.csv"),
    }
